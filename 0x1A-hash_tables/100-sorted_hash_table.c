...
/**
 * shash_table_add - to add element to the @ht hash table when it doesn't exist
 *
 * @ht: the hash table to add the key/value to
...
/**
 * shash_table_set - to add an element to the @ht hash table
 *
...
/**
 * shash_table_print - to print a hash table
 *
...
/**
 * shash_table_print_rev - to rev print a hash table
 *
 * @ht: the hash table to print
 */
...
/**
 * shash_table_delete - to delete a hash table
 *
